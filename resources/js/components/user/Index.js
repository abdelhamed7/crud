...
class Index extends Component
{
	...
	handleDeleteUser(userId)
	{
		axios.delete(`/api/users/${userId}`)
			.then(response => {
				toastr.error('Author has been deleted successfully!', {position : 'top-right', heading: 'Done'});
      ...
      return(
          	<div className="card mt-4">
			    <div className="card-header">
			        ...
			        <button type="button" className="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#addModal"> Add authors </button>
			    </div>
