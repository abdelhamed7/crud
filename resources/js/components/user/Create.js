	...
	handleInsertUser(e)
	{
		...
		axios.post('/api/users', data)
			.then(repsonse => {
				...
				toastr.success('New author added successfully!', {position : 'top-right', heading: 'Done'});
			})
			.catch(error => {
				this.setState({
			  	...
			  	<div className="modal-dialog" role="document">
			    	<div className="modal-content">
			      		<div className="modal-header">
			        		<h5 className="modal-title">New Authors</h5>
			        ...
			        <form onSubmit={this.handleInsertUser}>
			      		...
			      		<div className="modal-footer">
			        		...
			        		<button type="submit" className="btn btn-primary btn-sm">Save author</button>
			      		</div>
			   		</form>
			    	</div>
			  	</div>
